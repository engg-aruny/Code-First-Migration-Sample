...
namespace Code_First_Migration_Sample.Migrations
{
    ...
    [Migration("20230404023448_AddGenderColumn")]
            ...
            modelBuilder.Entity("Code_First_Migration_Sample.Models.StudentEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            DateOfBirth = new DateTime(2023, 4, 4, 8, 4, 47, 994, DateTimeKind.Local).AddTicks(1655),
                        ...
                        {
                            ID = 2,
                            DateOfBirth = new DateTime(2023, 4, 4, 8, 4, 47, 994, DateTimeKind.Local).AddTicks(1664),
